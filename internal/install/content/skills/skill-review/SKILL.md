...
description: >
  ...
  plugin skills quality. NOT for general code review (use /alfred:review).
  NOT for CLAUDE.md or hooks review (use /alfred:review config).
user-invocable: true
...
# /alfred:skill-review — Skill Best Practices Auditor
